...
Object = collections.namedtuple('Object', ('bbox'))
Object.__str__ = lambda self: 'Object(%s)' % self
...
def convert(obj, labels):
    ...
    return Object(bbox=BBox(x=x0, y=y0, w=x1 - x0, h=y1 - y0))
...
def render_gen(args):
    ...
    while True:
        ...
        if draw_overlay:
            ...
            objs = [obj for obj in objs if 0.0 <= obj.bbox.area() <= 1.0]
